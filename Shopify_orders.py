...
def process_shopify_csv(csv_path):
    ...
    df = df[['Name', 'Created at', 'Shipping Phone', 'Total', 'Lineitem name', 'Lineitem quantity']]
    ...
    df[['Created at', 'Shipping Phone', 'Total']] = df.groupby('Name')[['Created at', 'Shipping Phone', 'Total']].transform('first')
    grouped = {}
...
if __name__ == "__main__":
    folder_path = r"W:\Data Entry Work"  # Change to your folder path if needed
